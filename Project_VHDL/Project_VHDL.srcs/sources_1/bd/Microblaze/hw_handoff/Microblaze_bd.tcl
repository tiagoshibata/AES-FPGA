...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: vhdl_axi_aes_final_v1_2_0, and set properties
  set vhdl_axi_aes_final_v1_2_0 [ create_bd_cell -type ip -vlnv user.org:user:vhdl_axi_aes_final_v1_2:1.2 vhdl_axi_aes_final_v1_2_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins vhdl_axi_aes_final_v1_2_0/axi_aes]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins vhdl_axi_aes_final_v1_2_0/axi_aes_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs vhdl_axi_aes_final_v1_2_0/axi_aes/reg0] SEG_vhdl_axi_aes_final_v1_2_0_reg0
