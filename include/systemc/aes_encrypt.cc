...
void AES_Encrypt::get_next_state()
{
	if (clear) {
		...
		case aes_enc_st_addroundkey:
			snext = aes_enc_st_round_odd;
			break;
		case aes_enc_st_round_odd:
			snext = aes_enc_st_round_even;
			break;
		case aes_enc_st_round_even:
			if (round > 0) {
				snext = aes_enc_st_round_odd;
			} else {
				snext = aes_enc_st_round_last;
			}
			break;
		case aes_enc_st_round_last:
			snext = aes_enc_st_subbytes;
			break;
		case aes_enc_st_subbytes:
